...
Provides
    - A ``python`` module for conducting a combinatorial optimization on
      a given dataset of discrete items.

Metadata
--------
:Module:        ``or.comboptimize``
:Filename:      `comboptimize.py <https://github.com/KeiferC/operations-research>`_
...
Documentation
-------------
Documentation for the ``comboptimize`` module can be found as docstrings. 
Run ``import or.combotimize; help(or.combotimize)`` to view documentation.
::
    $ python
    >>> import or.combotimize; help(or.combotimize)
